...
function View(props) {
  ...
  //열람 API는 JSON객체이므로 빈 객체를 초기값으로 지정
  let [boardData, setBoardData] = useState({});
  //API 요청 주소
  let requestUr1 = "http://nakja.co.kr/APIs/php7/boardViewJSON.php";
  //파라미터(쿼리스트링)
  let parameter = "tname=nboard_news&apikey=1ee1d88c6a56ee2ec5d6591623144c96&idx="+params.idx;
        ...
        if(window.confirm('삭제하시겠습니까?')){
          ...
          fetch("http://nakja.co.kr/APIs/php7/boardDeleteJSON.php", {
            ...
            body: new URLSearchParams({
              tname: 'nboard_news',
              idx: params.idx,
              apikey: '1ee1d88c6a56ee2ec5d6591623144c96',
            }),
          })
          .then((result)=>{
            return result.json();
