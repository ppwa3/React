            ...
            <tbody>
              <tr className="post-row">
                ...
                <td className="title-cell">
                  <Link to={`/qnaview/${post.id}`} className="title-link">
                    {post.title}
                  </Link>
                </td>
                ...
                <td className="cen">
                  <button onClick={() => {handleDelete(post.id); navigate("/qnalist");}} className="delete-button">
                    삭제
                  </button>
                  <button onClick={() => {navigate("/qnaedit/"+ params.id);}} className="delete-button">
                    수정
                  </button>
                </td>
              </tr>
